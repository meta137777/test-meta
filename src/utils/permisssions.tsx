...
export function getPermissions() {
  ...
  const menu = [
    // All users
    {
      ...
      href: Array.isArray(roles) ? `/panel/${roles[0]}/info` : ``,
      permission: [
        "User",
        "SuperAdmin",
        "CallCenterExpert",
    ...
    },
    {
      ...
      href: Array.isArray(roles) ? `/panel/${roles[0]}/ads` : ``,
      permission: [
        "User",
        "SuperAdmin",
        "CallCenterExpert",
...

    {
      ...
      icon: <TableDocument size="18" color="#FFF" variant="TwoTone" />,
      href: Array.isArray(roles) ? `/panel/${roles[0]}/orders/vip` : ``,
      permission: [
        "User",
        "SuperAdmin",
        "CallCenterExpert",
    ...
    },
    {
      ...
      icon: <DocumentText size="18" color="#FFF" variant="TwoTone" />,
      href: "/panel/admin/car-installment-requests",
      permission: ["OperationsDirector"],
    },
    {
      value: " درخواست‌های اقساطی نمایشگاه‌داران",
      icon: <DocumentText size="18" color="#FFF" variant="TwoTone" />,
    ...
    // User
    {
      ...
      icon: <DocumentText size="18" color="#FFF" variant="TwoTone" />,
      href: Array.isArray(roles) ? `/panel/${roles[0]}/vehicle-check` : ``,
      permission: [
        "User",
        "SuperAdmin",
        "CallCenterExpert",
    ...
    // All users
    {
      ...
      href: Array.isArray(roles) ? `/panel/${roles[0]}/likes` : ``,
      permission: [
        "User",
        "SuperAdmin",
        "CallCenterExpert",
    ...
    },
    {
      ...
      href: Array.isArray(roles) ? `/panel/${roles[0]}/recent-searches` : ``,
      permission: [
        "User",
        "SuperAdmin",
        "CallCenterExpert",
  ...
  const filteredMenu = menu.filter((item) =>
    item.permission.some((role) => Array.isArray(roles) && roles.includes(role))
  );
