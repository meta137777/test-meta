export function getExhibitorMenu(status: string, leasing: any) {
  ...
  switch (status) {
    ...
    case "در انتظار ثبت اطلاعات ضامنین":
      let newLink5 = {
        link:
          leasing.installment_info.facility_amount >= 3000000000 &&
          leasing.installment_info.facility_amount < 6000000000
    ...
    case "در انتظار ثبت تاریخ قرارداد":
      let newLink18 = {
        link: `/panel/exhibitor/leasing/set-contract-date/${leasing.exhibitor_leasing_id}`,
        title: "ثبت تاریخ قرارداد",
      };

      links.push(newLink18);
      break;
