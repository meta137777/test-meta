...
const SellerAccountNumber = () => {
  ...
  const validationSchema = Yup.object({
    ...
    car_owner_info_seller_account: Yup.string().test('length', 'مقدار وارد شده صحیح نیست', val => val.length === 24).required(
    ...
    car_owner_info_bank_branch: Yup.string().required("نام شعبه الزامی است."),
  });
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-2">
              <FormInput
                ...
                // type="number"
                classNames="w-full text-left ltr"
              />
