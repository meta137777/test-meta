...
import WordTemplate from "../customer-online-contract/components/word-tepmlate";
      ...
      {loading ? (
        ...
        <>
          ...
          <FirstValidationForm
            ...
            contaract_date={
              state.contract_date_year
                ? `${state.contract_date_year}/${state.contract_date_month}/${state.contract_date_day}`
                : ""
            }
          ...
          {/* قرارداد آنلاین */}
          {state?.exhibitor_leasing_contract?.pdf_id && (
            <div className="mt-8 flex flex-col">
              ...
              <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4 mt-4">
                <DownloadDocument
                  file={{
                    image_id:
                      state?.exhibitor_leasing_contract?.pdf_id?.replace(
                        /,\s*$/,
                        ""
                      ),
                    name: "قرارداد آنلاین",
