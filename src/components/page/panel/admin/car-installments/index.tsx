...
export default function CardAdminInstallmentList({ data }:any) {
  return (
    <>
...
const TableItem = ({ index, data }) => {
  ...
  const showUserInfoHadler = () => {
    navigate.push(`/panel/admin/car-installment-requests/detail`, {
      state: {
  ...
  return (
    <div className="tablet:col-span-9 col-span-1 tablet:grid lg:grid-cols-12 tablet:grid-cols-5 tablet:gap-0 gap-2  flex flex-col items-center rounded-tr-tablet rounded-tl-tablet tablet:px-6 tablet:py-12 p-5 tablet:border-0 border border-gray-300 rounded-lg lg:border-b border-b-gray-300 lg:rounded-none">
      ...
      <div className="tablet:block flex justify-between w-full lg:col-span-3">
      ...
      <div className="tablet:block flex justify-between w-full">
      ...
      <div className="tablet:block flex justify-between w-full items-center lg:col-span-2">
        <span className="tablet:hidden block font-bold text-sm">وضعیت</span>
        <div className="text-sm font-medium ">{data.status}</div>
      </div>

      <div
        className="flex justify-end w-full items-center lg:col-span-2"
