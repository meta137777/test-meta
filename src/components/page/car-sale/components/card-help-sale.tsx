...
const CardHelpSale = () => {
  const Items = [
    ...
    },
    {
      ...
      desc: "جهت ایجاد آگهی فروش در اُتو باید درج مشخصات فردی، اطلاعات فنی و بدنه، توضیحات تکمیلی آگهی خودرو و بارگذاری عکس‌های خودرو صورت پذیرد.",
    },
    {
      img: icons.coordinatvisit_icon.src,
      title: "هماهنگی زمان بازدید",
      desc: "در این مرحله هماهنگی‌های لازم برای روز و ساعت بازدید خودرو از سمت اُتو با فروشنده و خریدار انجام می‌پذیرد.",
    },
  ];
  return (
    <div className="my-20">
