...
const SelectSortBy = ({
  ...
  return (
    <div
      className="mb-4 lg:mt-8 lg:col-span-3 tablet:col-span-3 md:col-span-2 md:bg-gray-150 md:border-0 border border-gray-200 rounded-lg leading-relaxed px-2 py-1 md:rounded-2xl flex items-center text-sm md:static md:z-0 z-10 fixed top-[8.5rem] right-28 md:cursor-auto cursor-pointer lg:z-auto zIndex-100"
