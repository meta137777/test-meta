import { PostAdSaleIdImagesAdd } from "@/apis/car-sale";
...
export default function MyAdMultipleImageModal({
  advertiser_id,
  setLoadImage,
  image_guides,
  tempImages = [],
  tempStatus,
  tempLastImagesLength,
}?: any) {
  ...
  let imageArray = image_guides?.split(",");
  ...
  const handleSubmitImage = (e) => {
    ...
    if (imgsSrc.length !== 0) {
      ...
      PostAdSaleIdImagesAdd(advertiser_id, data)
        .then(() => {
  ...
  return (
    <div className="lg:col-span-2 col-span-7 lg:h-full h-auto flex flex-col justify-center items-center lg:object-cover object-fit m-auto lg:border-0 border-b border-gray-600 lg:p-0 p-4 lg:w-auto w-full my-8">
        ...
        <Box sx={style}>
          ...
          <div className="flex flex-col w-full">
            <ImageUploader
              ...
              imageCount={20 - imageArray?.length - 1}
              tempStatus={tempStatus}
              tempLastImagesLength={tempLastImagesLength}
            />
            <button
