...
const SelectYear = ({
  ...
  const [yearMiladi, setYearMiladi] = useState(yearType);
  ...
  return (
    <div className="relative">
      <span
        ...
        }px-2 py-1 rounded-full absolute left-2 z-10 cursor-pointer ${
          badgeClassName ? badgeClassName : "top-2"
        }`}
