        ...
        <div className="lg:mb-0 mb-10 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-8">
          ...
          <div className="lg:col-span-3 md:col-span-2 col-span-1 md:flex flex-row grid grid-cols-1 gap-2 items-center">
            <span className="block sm:whitespace-nowrap  md:text-sm text-xs md:order-first order-last md:text-right text-center md:mt-0 mt-4">
              © کلیه حقوق این سایت متعلق به شرکت مروارید تِک آمانج (oto.ir) است.
              <br />
              <p>V1.3.9</p>
            </span>
            <div className="flex gap-2 w-full items-center">
              ...
              {/* <a referrerpolicy='origin' target='_blank' href='https://trustseal.enamad.ir/?id=434733&Code=Dp5UeDRASrkgb1voXkY74yGiegyjWVXt'><img referrerpolicy='origin' src='https://trustseal.enamad.ir/logo.aspx?id=434733&Code=Dp5UeDRASrkgb1voXkY74yGiegyjWVXt' alt='' style='cursor:pointer' Code='Dp5UeDRASrkgb1voXkY74yGiegyjWVXt'></a> */}

              <Link href="https://trustseal.enamad.ir/?id=434733&Code=Dp5UeDRASrkgb1voXkY74yGiegyjWVXt">
                <img
                  referrerPolicy="origin"
                  src="https://trustseal.enamad.ir/logo.aspx?id=434733&Code=Dp5UeDRASrkgb1voXkY74yGiegyjWVXt"
                  alt=""
