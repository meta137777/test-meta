...
const cards = [
  {
    ...
    desc: " امکانات این پکیج  شامل کارشناسی یک خودرو توسط کارشناسان خبره اُتو است. اعتبار استفاده از خدمات کارشناسی  پکیج 21روز است. پس از این بازه، اعتبار پکیج منقضی گردیده و مبلغ باقی مانده قابل استرداد نخواهد بود.",
    off: "",
  ...
  },
  {
    ...
    desc: " امکانات این پکیج  شامل کارشناسی پنج خودرو با تخفیف 35 درصد، توسط کارشناسان خبره اُتو است.  اعتبار استفاده از خدمات کارشناسی  پکیج 21روز است. پس از این بازه، اعتبار پکیج منقضی گردیده و مبلغ باقی مانده قابل استرداد نخواهد بود.",
    off: "35",
  ...
  },
  {
    ...
    desc: "امکانات این پکیج  شامل کارشناسی سه خودرو با تخفیف 20 درصد، توسط کارشناسان خبره اُتو است. اعتبار استفاده از خدمات کارشناسی  پکیج 21روز است.پس از این بازه، اعتبار پکیج منقضی گردیده و مبلغ باقی مانده قابل استرداد نخواهد بود.",
    off: "20",
    listItems: ["ارائه گزارش حرفه‌ای کارشناسی", "ضمانت کارشناسی"],
    id: 3,
  },
  ...
  const tipBoxes = [
    {
      ...
      desc: "با استفاده از کارشناسی اُتو، نسبت به سلامت فنی و بدنه خودرو اطمینان حاصل خواهید کرد.",
    },
    {
      title: "بهترین قیمت",
      img: img.trade.src,
      desc: "اُتو سعی می‌کند ارزش‌گذاری واقعی و منصفانه از قیمت خودرو به شما ارائه دهد.",
    },
    {
      title: "ضمانت‌نامه",
      img: img.for_you.src,
      desc: "اُتو نتیجه بررسی فنی و بدنه خودرو را پس از کارشناسی به دو صورت آنلاین و نسخه چاپی به شما ارائه می‌دهد.",
    },
  ];
  ...
  return (
    <div className="">
      <div className="flex flex-wrap gap-1 font-bold justify-center md:text-2xl text-xl mb-8">
        ...
        <span className="font-bold whitespace-nowrap">با اُتو؟</span>
      </div>
...
export const VehicleCheckSteps = () => {
  const vehicleCheckStepsItems = [
    {
      ...
      desc: " کارشناسان اُتو، با حضور در قرار بازدید، مسائل فنی و حقوقی معامله‌ را تضمین می‌کنند.",
    },
    {
  ...
  return (
    <div className="flex flex-col gap-6  justify-center">
      ...
      <img
        className="w-[802px] mx-auto md:block hidden"
